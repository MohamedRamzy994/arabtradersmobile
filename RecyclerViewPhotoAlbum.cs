...
namespace ArabTradersGroup_v1
{
...

    {
        ...
        static Photo[] mBuiltInPhotos = {
            ...
            new Photo { mPhotoID = Resource.Drawable.p_1,

                        mCaption = "Split broad beans" },

            new Photo { mPhotoID = Resource.Drawable.p_2,

                        mCaption = "Lupine" },

            new Photo { mPhotoID = Resource.Drawable.p_3,

                        mCaption = "Egyptian Rice" },

            new Photo { mPhotoID = Resource.Drawable.p_4,

                        mCaption = "Corn popcorn" },

            new Photo { mPhotoID = Resource.Drawable.p_5,

                        mCaption = "Egyptian Beans" },

            new Photo { mPhotoID = Resource.Drawable.p_6,

                        mCaption = "Red split lentils" },

            new Photo { mPhotoID = Resource.Drawable.p_7,

                        mCaption = "White Beans" },

            new Photo { mPhotoID = Resource.Drawable.p_8,
